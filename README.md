...
* `cacti_spine_version`: [default: `release/1.2.16`]: What version of cacti-spine to check out (set up). This can be the full 40-character SHA-1 hash, the literal string HEAD, a branch name, or a tag name
...
- hosts: all
  ...
  vars:
    ...
    cacti_spine_version: fix-build-for-percona
